...
/*get this js file web path(js) */
var jsPath = (function() {var elements = document.getElementsByTagName('script');for (var i = 0, len = elements.length; i < len; i++) {	if (elements[i].src && elements[i].src.match(/Calendar.js/)) {return (elements[i].src.substring(0, elements[i].src.lastIndexOf('/')+1));}}return '';})();
jsPath = '/admin/include/calendar/';
...
//	(this.weekNumbers) && ++title_length;
	...
	this._nav_py = hh("<img id=objyprev src=\""+jsPath+"images/yprev.gif\">", 1, -2);
...
//	this._nav_py = hh("&#x00ab;", 1, -2);
	...
	//	this._nav_ny = hh("&#x00bb;", 1, 2);
	this._nav_ny = hh("<img id=objynext src=\""+jsPath+"images/ynext.gif\">", 1, 2);
	this._nav_ny.width = 20;
	this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//	this._nav_pm = hh("&#x2039;", 1, -1);
	this._nav_pm = hh("<img id=objmprev src=\""+jsPath+"images/mprev.gif\">", 1, -1);
...
//	this._nav_nm = hh("&#x203a;", 1, 1);
	this._nav_nm = hh("<img id=objmnext src=\""+jsPath+"images/mnext.gif\">", 1, 1);
...
//	this._nav_now.ttip = Calendar._TT["GO_TODAY"];
	...
	if (this.isPopup) {
		...
		var td_close = hh("<img id=objclose src=\""+jsPath+"images/close.gif\">", 1, 200);
		td_close.ttip = Calendar._TT["CLOSE"];
		td_close.align = "right";
		//hh("#<div><img src=\"/"+jsPath+"images/calendar/close.gif\" onmousedown=\"return;\"></div>", 1, 200).ttip = Calendar._TT["CLOSE"];
	}	
...
/** come from calendar-zh.js begin **/
...
/** come from calendar-setup.js begin **/
...
/** come from calendar-setup.js end **/