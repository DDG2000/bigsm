...
{ 
   $uploadfile = "./".time()."_".$groundImage; 
   copy($groundImage, $uploadfile);
   ...
   $isWaterImage = FALSE; 
	...
	{ 
        $ground_info = getimagesize($uploadfile); 
        $ground_w    = $ground_info[0];//取得背景图片的宽 
        $ground_h    = $ground_info[1];//取得背景图片的高 

        switch($ground_info[2]) 
		{   //取得背景图片的格式 
            case 1:$ground_im = imagecreatefromgif($uploadfile);break; 
            case 2:$ground_im = imagecreatefromjpeg($uploadfile);break; 
            case 3:$ground_im = imagecreatefrompng($uploadfile);break; 
            default:return 1; 
        } 
    } 
	else 
    ...
    switch($ground_info[2]) 
	{//取得背景图片的格式 
        case 1:imagegif($ground_im,$uploadfile);break; 
        case 2:imagejpeg($ground_im,$uploadfile);break; 
        case 3:imagepng($ground_im,$uploadfile);break; 
        default: return 6; 
    } 
 ...
 //imageWaterMark("9.jpg",9,"io.png","","","#CCFF00","arial.ttf","-9","-19");
?>
