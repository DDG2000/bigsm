...
if($outexcel){
    ...
    $tables = 'sm_item_factory uu where Status=1 and I_mall_classID='.$I_mall_classID.' and '.$mWhere.'';
...
$Rs=$ItemFactory->getListPage($CurrPage, $pagesize, $I_mall_classID,$mWhere);
