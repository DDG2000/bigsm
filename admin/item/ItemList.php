...
$Admin->CheckPopedoms('SM_ITEM_BASE');
...
//     $data=$item->getDataArray();
    $tables = 'sm_item uu where Status=1 and I_mall_classID='.$I_mall_classID.' and '.$mWhere.'';
...
//     $dat['fields'][]=array('账户余额','N_amount');
//     $dat['fields'][]=array('可用金额','number_format($Rs[$i][\'N_amount\']-$Rs[$i][\'N_amount_freeze\'],2,\'.\',\'\')','other');
//     $dat['fields'][]=array('冻结金额','N_amount_freeze');
//     $dat['fields'][]=array('待收金额','number_format($Rs[$i][\'N_amount_repossessed\'],2,\'.\',\'\')','other');
//     $dat['fields'][]=array('待还金额','number_format($Rs[$i][\'N_amount_revert\'],2,\'.\',\'\')','other');
...
//     $dat['fields'][]=array('提现冻结状态', '($Rs[$i][\'I_withdraw_blocked\']==1?\'已冻结\':\'未冻结\')','other');
//     $dat['fields'][]=array('会员期限','Dt_expire','date');
...
$Rs=$item->getItemListPage($CurrPage, $pagesize, $I_mall_classID,$mWhere);
