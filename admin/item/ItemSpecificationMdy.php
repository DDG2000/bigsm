...
$action = 'ItemSpecificationProcess.php';
...
$Admin->CheckPopedoms('SM_ITEM_SPECIFICATION_MDY');//编辑$title
...
if($Work=='ImportReco'){
    ...
    $params[] = array('val'=>'<a href="/data/resource/examples/specificationtemp.xls" class="but"><span style="margin:0">点击下载'.$title.'例子文件</span></a>','name'=>'模板文件','tip'=>'仅支持excel2007及以下版本');
