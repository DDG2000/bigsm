...
var humanMsg = {
	...
	removeMsg: function() {
		...
		var n=new Number(jQuery('#'+humanMsg.msgID).css('opacity'));
		// If message is fully transparent, fade it out
		if (n.toFixed(2) == humanMsg.msgOpacity){
			jQuery('#'+humanMsg.msgID).animate({ opacity: 0 }, 1000, function() {jQuery(this).hide() });
		}
	}
};
