...
class FindCarsModel extends AdminModel {
	...
	public function getPage ($currentPage,$param=[]) {
	    ...
	    if(iseta($param,'keywords')){
	           ...
	           $where['a.Vc_orderSn|su.Vc_name|a.Vc_senter|a.Vc_receiver'] =['like','%'.trim($param['keywords']).'%'];
	...
	public function getMQuery ($where = []) {
	    ...
	    ->field('a.*,si.Vc_name industryname,su.Vc_name username,su.Vc_mobile userphone,sp1.name proname1,sp2.name proname2,
