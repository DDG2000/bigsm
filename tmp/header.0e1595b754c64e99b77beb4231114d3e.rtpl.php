...
<div id="header">
    <div class="c w1100 cb top">
        <?php if( $lg ){ ?>
            你好！<?php echo $lg["hidemobile"];?>&nbsp;欢迎来到聚能<a href="/index.php?act=user&m=userprocess&w=lgout" id="exit">退出</a>
        <?php }else{ ?>
    ...
    <div class="header-con">
        <div class="c cb w1100">
            <a href="#" class="fl logo"><h1>聚能</h1></a>
            <span class="fl header-con-title">我的会员中心</span>
            <div class="con fl ib-a c-fff header-con-nav">
                <a href="#">钢材首页</a>
                <a href="/index.php?act=mall&m=list#">自营商城</a>
                <a href="/index.php?act=user&m=message&w=list#">消息</a>
            </div>
